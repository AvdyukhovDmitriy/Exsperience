...
DictContext& Builder::StartDict()
{
	...
	{
		throw std::logic_error("Start Dict is not valid in "s + __FUNCTION__);
	}
...
ArrayContext& Builder::StartArray()
{
	...
	{
		throw std::logic_error("Start Array is not valid in "s + __FUNCTION__);
	}
	return *this;
}
...
Builder& Builder::EndDict()
{
	...
	{
		throw std::logic_error("End Dict called not after start dict in "s + __FUNCTION__);
	}
...
Builder& Builder::EndArray()
{
	...
	{
		throw std::logic_error("End Array called not after start array in "s + __FUNCTION__);
	}
	if (last_operation_.back() != LastOperation::FINISH)
	{
		last_operation_.pop_back();
...
KeyContext& Builder::Key(std::string key)
{
	...
	{
		throw std::logic_error("Key called not after start dict in "s + __FUNCTION__);
	}
...
Builder& Builder::Value(Node::Value value)
{
	...
	{
		throw std::logic_error("Value is not valid in "s + __FUNCTION__);
	}
...
Node Builder::Build()
{
	if (last_operation_.back() != LastOperation::FINISH)
	{
		throw std::logic_error("Build called before finish building the object in "s + __FUNCTION__);
	}
	else
	{
